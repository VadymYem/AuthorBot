...
> 3. **Модель**: Рекомендується використовувати `gemini-1.5-flash` або `gemini-3-flash-preview`. Обидві моделі мають **безкоштовний рівень** (Free of charge) для використання в AI Studio.
