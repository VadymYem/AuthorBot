...
from ..types import AcbotReplyMarkup
...
class Gallery(InlineUnit):
    async def gallery(
        ...
        *,
        custom_buttons: typing.Optional[AcbotReplyMarkup] = None,
        force_me: bool = False,
        ...
        :param gif: Whether the gallery will be filled with gifs. If you omit this argument and specify
                    gifs in `next_handler`, acbot will try to determine the filetype of these images
        :param manual_security: By default, acbot will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, acbot will try to inherit inline buttons security from the caller (command)
        ...
        with contextlib.suppress(AttributeError):
            _acbot_client_id_logging_tag = copy.copy(self._client.tg_id)
