...
class AcbotSecurityMod(loader.Module):
    ...
    strings_ua = {
        ...
        "permissions": (
            "🔐 <b>Тут можна налаштувати дозволи для команди </b><code>{}{}</code>"
        ),
        "close_menu": "🙈 Закрити це меню",
        "global": (
            "🔐 <b>Тут можна налаштувати виключення. Якщо тумблер"
            " вимкнено тут, він ввімкнений для всіх команд</b>"
        ),
        "owner": "😎 Власник",
        "sudo": "🧐 Sudo",
        "support": "🤓 Помічник",
        "group_owner": "🧛‍♂️ Власник групи",
        "group_admin_add_admins": "🧑‍⚖️ Адмін (додавати користувачів)",
        ...
        "pm": "🤙 В лс",
        "owner_list": (
            "<emoji document_id=5386399931378440814>😎</emoji> <b>Користувачі групи"
            " </b><code>owner</code><b>:</b>\n\n{}"
        ),
        "sudo_list": (
            "<emoji document_id=5418133868475587618>🧐</emoji> <b>Користувачі групи"
            " </b><code>sudo</code><b>:</b>\n\n{}"
        ),
        "support_list": (
            "<emoji document_id=5415729507128580146>🤓</emoji> <b>Користувачі групи"
            " </b><code>support</code><b>:</b>\n\n{}"
        ),
        "no_owner": (
            "<emoji document_id=5386399931378440814>😎</emoji> <b>Немає користувачів в"
            " групі </b><code>owner</code>"
        ),
        "no_sudo": (
            "<emoji document_id=5418133868475587618>🧐</emoji> <b>Немає користувачів в"
            " группе </b><code>sudo</code>"
        ),
        "no_support": (
            "<emoji document_id=5415729507128580146>🤓</emoji> <b>Немає користувачів в"
            " группе </b><code>support</code>"
        ),
        "no_user": (
            "<emoji document_id=5415905755406539934>🚫</emoji> <b>Вкажи, кому видавати"
            " права</b>"
        ),
        "not_a_user": (
            "<emoji document_id=5415905755406539934>🚫</emoji> <b>Вказана ціль - не"
            " користувач</b>"
        ),
        "cancel": "🚫 Відмінити",
        "confirm": "👑 Підтвердити",
        "self": (
            "<emoji document_id=5415905755406539934>🚫</emoji> <b>Не можна керувати"
            " своїми правами!</b>"
        ),
        "warning": (
            '⚠️ <b>Ти дійсно хочеш додати <a href="tg://user?id={}">{}</a> в'
            " группу </b><code>{}</code><b>!\nЦя дія може передати частковий або"
            " повний доступ до юзерботу цьому користувачеві!</b>"
        ),
        "suggest_nonick": (
            "🔰 <i>Хочеш ввімкнути NoNick для цього користувача?</i>"
        ),
        "user_nn": '🔰 <b>NoNick для <a href="tg://user?id={}">{}</a> ввімкнено</b>',
        "enable_nonick_btn": "🔰 Ввімкнути",
        "owner_added": (
            '<emoji document_id="5386399931378440814">😎</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> додано до групи </b><code>owner</code>'
        ),
        "sudo_added": (
            '<emoji document_id="5418133868475587618">🧐</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> додано до групи </b><code>sudo</code>'
        ),
        "support_added": (
            '<emoji document_id="5415729507128580146">🤓</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> додано до групи </b><code>support</code>'
        ),
        "owner_removed": (
            '<emoji document_id="5386399931378440814">😎</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> видалено з групи </b><code>owner</code>'
        ),
        "sudo_removed": (
            '<emoji document_id="5418133868475587618">🧐</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> видалено з групи </b><code>sudo</code>'
        ),
        "support_removed": (
            '<emoji document_id="5415729507128580146">🤓</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> видалено з групи </b><code>support</code>'
        ),
        "_cls_doc": "Керування налаштуваннями безпеки",
        "what": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Вам потрібно вказати"
            " тип цілі першим аргументом (</b><code>user</code><b> or"
            " </b><code>chat</code><b>)</b>"
        ),
        "no_target": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Не вказано ціль"
            " правила безпеки</b>"
        ),
        "no_rule": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Не вказано правило"
            " безпеки (модуль чи команда)</b>"
        ),
        "confirm_rule": (
            "🔐 <b>Будь-ласка, підтвердьте що хочете видати {} <a href='{}'>{}</a>"
            " право використовувати {} </b><code>{}</code><b> {}</b>"
        ),
        "multiple_rules": (
            "🔐 <b>Не вийшло однозначно розпізнати правила безпеки. Виберіть"
            " те, яке мали на увазі:</b>\n\n{}"
        ),
        "rule_added": (
            "🔐 <b>Ви видали {} <a href='{}'>{}</a> право"
            " використовувати {} </b><code>{}</code><b> {}</b>"
        ),
        "rules": (
            "<emoji document_id=5472308992514464048>🔐</emoji> <b>Таргетовані"
            " правила безпеки:</b>\n\n{}"
        ),
        "no_rules": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Немає таргетованих"
            " правил безпеки</b>"
        ),
        "owner_target": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Цей користувач -"
            " власник, його права не можуть керуватися таргетованою"
            " безпекою</b>"
        ),
        "rules_removed": (
    ...
    @loader.owner
    @loader.command(ua_doc="[команда] - Налаштувати дозволи для команди")
    ...
    @loader.owner
    @loader.command(ua_doc="[команда] - Налаштувати дозволи для інлайн команди")
    ...
    @loader.command(
        ua_doc='<"user"/"chat"> - Видалити правило таргетованої безпеки'
    )
    ...
    @loader.command(
        ua_doc=(
            '<"user"/"chat"> [ціль - користувач чи чат] [правило - команда чи'
            " модуль] [час] - Налаштувати таргетовану безпеку"
        )
    )
