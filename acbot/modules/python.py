...
from ..log import AcbotException
...
class PythonMod(loader.Module):
    ...
    async def e(self, message: Message):
        ...
        try:
            ...
            item = AcbotException.from_exc_info(*sys.exc_info())
            exc = (
                "\n<b>🪐 Full stack:</b>\n\n"
            ...
            exc = exc.replace(str(self._client.acbot_me.phone), "📵")
        ...
        ret = ret.replace(str(self._client.acbot_me.phone), "📵")
