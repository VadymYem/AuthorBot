...
class TestMod(loader.Module):
    ...
    strings_ua = {
        "set_loglevel": "🚫 <b>Вкажи рівень логів числом або строчкою</b>",
        ...
        "bad_module": "🚫 <b>Модуль не знайдено</b>",
        "debugging_enabled": (
            "🧑‍💻 <b>Режим розробника ввімкнено для модуля"
            " </b><code>{0}</code>\n<i>Звернись в директорію `debug_modules`,"
            " зміни файл `{0}.py`, і дивись зміни в режимі реального часу</i>"
        ),
        "debugging_disabled": "✅ <b>Режим розробника вимкнено</b>",
        "suspend_invalid_time": (
            "<emoji document_id=5416024721705673488>💀</emoji> <b>ННевірний формат часу"
            " заморозки</b>"
        ),
        "suspended": (
        ...
        "confidential": (
            "⚠️ <b>Рівень логів </b><code>{}</code><b> може мати особисту"
            " июінформацію, будь обережним</b>"
        ),
        "confidential_text": (
            "⚠️ <b>Рівень логів </b><code>{0}</code><b> може мати особисту"
            " інформацію, будь обережним</b>\n<b>Напиши </b><code>.logs {0}"
            " force_insecure</code><b>, щоб відправити лог ігноруючи"
            " попередження</b>"
        ),
        "choose_loglevel": "💁‍♂️ <b>Вибери рівень логів</b>",
        "_cmd_doc_dump": "Показати інфо про повідомлення",
        "_cmd_doc_logs": (
            "<уровень> - Відправляє лог-файл. Рівні нижче WARNING можуть мати"
            " особисту інформацію."
        ),
        "_cmd_doc_suspend": "<время> - Заморозити бота на деякий час",
        "_cmd_doc_ping": "Перевіряє швидкість роботи AuthorChe's",
        "_cls_doc": "Операції, зв`язані з самостійністю",
    }
