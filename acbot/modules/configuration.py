...
class AcbotConfigMod(loader.Module):
    ...
    strings_ua = {
        "choose_core": "🎚 <b>Вибери категорію</b>",
        "configure": "🎚 <b>Вибери модуль для налаштування</b>",
        "configure_lib": "🪴 <b>Вибери бібліотеку для налаштування</b>",
        "configuring_mod": (
            "🎚 <b>Вибери параметр для модуля</b> <code>{}</code>\n\n<b>Задіснені"
            " налаштування:</b>\n\n{}"
        ),
        "configuring_lib": (
            "🪴 <b>Вибери параметр для бібліотеки</b> <code>{}</code>\n\n<b>Задійснені"
            " налаштування:</b>\n\n{}"
        ),
        "configuring_option": (
            "🎚 <b>Керування параметром </b><code>{}</code><b> модуля"
            " </b><code>{}</code>\n<i>ℹ️ {}</i>\n\n<b>Стандартне:"
            " {}</b>\n\n<b>Задійснене: {}</b>\n\n{}"
        ),
        "configuring_option_lib": (
            "🪴 <b>Керування параметром </b><code>{}</code><b> бібліотеки"
            " </b><code>{}</code>\n<i>ℹ️ {}</i>\n\n<b>Стандартне:"
            " {}</b>\n\n<b>Задійснене: {}</b>\n\n{}"
        ),
        "option_saved": (
        ...
        "option_saved_lib": (
            "🪴 <b>Параметр </b><code>{}</code><b> бібліотеки </b><code>{}</code><b>"
            " збережено!</b>\n<b>Задійснено: {}</b>"
        ),
        "option_reset": (
        ...
        "_cls_doc": "Інтерактивний конфігуратор acbot",
        "args": "🚫 <b>Ти вказав неправильні аргументи</b>",
        "no_mod": "🚫 <b>Модулю не існує</b>",
        "no_option": "🚫 <b>У модуля нема такого значення конфігу</b>",
        "validation_error": (
            "🚫 <b>Введено некоректне значення конфіга. \nПомилка: {}</b>"
        ),
        "try_again": "❇ Спробуватиув ще раз",
        "typehint": "🕵️ <b>Має бути {}</b>",
        "set": "поставити",
        "set_default_btn": "♻️ Значення за умовчуванням",
        "enter_value_btn": "✍️ Ввести значенням",
        ...
        "remove_item_btn": "➖ Видалити элемент",
        "show_hidden": "🚸 Показати значення",
        "hide_value": "🚭 Приховати значение",
        "builtin": "🛰 Вбудовані",
        "external": "🛸 Зовнішні",
