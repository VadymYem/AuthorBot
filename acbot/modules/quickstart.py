...
📼 <b>Ти можеш шукати й встановлювати модулі через @hikkamods_bot або @ftg2bot. Просто введи пошуковий запит й нажми ⛩ Install на потрібному модулі або скористайся .dlmod</b>
...
4️⃣ <b>Напиши </b><code>.loadmod</code> <b>в відповідт на файл, щоб завантажити модуль з нього</b>
