...
class AcbotSettingsMod(loader.Module):
    ...
    strings = {
        ...
        "btn_no": "🔻 Cancel",
        "lavhost_web": (
            "✌️ <b>This link leads to your acbot web interface on lavHost</b>\n\n<i>💡"
    ...
    strings_ru = {
        ...
        "inline_settings": "⚙️ <b>Здесь можно управлять настройками acbot</b>",
        ...
        "_cls_doc": "Дополнительные настройки acbot",
        "nonick_warning": (
            "Внимание! Ты включил NoNick со стандартным префиксом! "
            "Тебя могут замьютить в чатах acbot. Измени префикс или "
        ...
        "deauth_confirm": (
            "⚠️ <b>Это действие полностью удалит acbot с этого аккаунта! Его нельзя"
            " отменить</b>\n\n<i>- Все чаты, связанные с acbot будут удалены\n- Сессия"
            " acbot будет сброшена\n- Инлайн бот acbot будет удален</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Ты точно уверен, что хочешь удалить acbot?</b>",
        "deauth_yes": "Я уверен",
        ...
        "uninstall": "😢 <b>Удаляю acbot...</b>",
        "uninstalled": (
            "😢 <b>acbot удалена. Веб-интерфейс все еще активен, можно добавить другие"
            " аккаунты!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>Эта команда дает доступ к веб-интерфейсу acbot. Ее выполнение в"
        ...
        "opening_tunnel": "🔁 <b>Открываю тоннель к веб-интерфейсу acbot...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻 Закрыть",
        "lavhost_web": (
            "✌️ <b>По этой ссылке ты попадешь в веб-интерфейс acbot на"
    ...
    @loader.owner
    @loader.command(ru_doc="Удалить acbot")
    ...
    @loader.owner
    @loader.command(ru_doc="Открыть тоннель к веб-интерфейсу acbot")
