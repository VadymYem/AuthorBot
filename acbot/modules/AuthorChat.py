...
class AuthorChatPlusMod(loader.Module):
    ...
    strings = {
        ...
        "protections": (
            ...
            "<b>🥷 <code>.authorsecurity</code> - Automatic version of AntiRaid\n"
    ...
    strings_ua = {
        ...
        "antitagall_on": "🐵 <b>AntiTagAll тепер включено в цьому чаті\nДія: {}</b>",
        "antitagall_off": "🐵 <b>AntiTagAll тепер вимкнено в цьому чаті</b>",
        "antiarab_on": "🐻 <b>AntiArab тепер включений у цьому чаті\nДія: {}</b>",
        "antiarab_off": "🐻 <b>AntiArab тепер вимкнено в цьому чаті</b>",
        "antizalgo_on": "🌀 <b>AntiZALGO тепер включено в цьому чаті\nДія: {}</b>",
        "antizalgo_off": "🌀 <b>AntiZALGO тепер вимкнено в цьому чаті</b>",
        "antistick_on": "🎨 <b>AntiStick тепер включено в цьому чаті\nДія: {}</b>",
        "antistick_off": "🎨 <b>AntiStick тепер вимкнено в цьому чаті</b>",
        "antihelp_on": "🐺 <b>AntiHelp тепер включений у цьому чаті</b>",
        "antihelp_off": "🐺 <b>AntiHelp тепер вимкнено в цьому чаті</b>",
        "antiraid_on": "🐶 <b>AntiRaid тепер включено в цьому чаті\nДія: {}</b>",
        "antiraid_off": "🐶 <b>AntiRaid тепер вимкнено в цьому чаті</b>",
        "antichannel_on": "📯 <b>AntiChannel тепер включений у цьому чаті</b>",
        "antichannel_off": "📯 <b>AntiChannel тепер вимкнено в цьому чаті</b>",
        "report_on": "📣 <b>Report тепер включений у цьому чаті</b>",
        "report_off": "📣 <b>Report тепер вимкнено в цьому чаті</b>",
        "antiflood_on": "⏱ <b>AntiFlood тепер включено в цьому чаті\nДія: {}</b>",
        "antiflood_off": "⏱ <b>AntiFlood тепер вимкнено в цьому чаті</b>",
        "antispoiler_on": "🪙 <b>AntiSpoiler тепер включений у цьому чаті</b>",
        "antispoiler_off": "🪙 <b>AntiSpoiler тепер вимкнено в цьому чаті</b>",
        "antigif_on": "🎑 <b>AntiGIF тепер включений у цьому чаті</b>",
        ...
        "welcome": "👋 <b>Тепер я вітатиму людей у ​​цьому чаті</b>\n{}",
        "unwelcome": "👋 <b>Я більше не вітатиму людей у ​​цьому чаті</b>",
        "chat404": "🔓 <b>Цей чат ще не захищений.</b>\n",
        "not_admin": "🤷‍♂️ <b>Я тут не адмін, або у мене недостатньо прав</b>",
        "no_defense": "🛡 <b>Федеративний список захисту порожній</b>",
        "defense_list": "🛡 <b>Федеративний список захисту:</b>\n{}",
        "fed404": "💼 <b>Федерація не знайдена</b>",
        "fedexists": "💼 <b>Федерація існує</b>",
        "joinfed": "💼 <b>Приєднався до федерації</b>",
        "namedfed": "💼 <b>Федерацію перейменовано на {}</b>",
        "nofed": "💼 <b>Цей чат не знаходиться в жодній федерації</b>",
        "feds_header": "💼 <b>Федерації:</b>\n\n",
        "no_fed": "💼 <b>Цей чат не перебуває в жодній із федерацій</b>",
        "api_error": "🚫 <b>Помилка з'єднання!</b>\n<code>{}</code>",
        "fsave_args": "💼 <b>Приклад: .fsave shortname <відповідь></b>",
        "fstop_args": "💼 <b>Приклад: .fstop shortname</b>",
        "fsave": "💼 <b>Федеративна замітка </b><code>{}</code><b> збережена!</b>",
        "fstop": "💼 <b>Федеративна замітка </b><code>{}</code><b> видалена!</b>",
        "fnotes": "💼 <b>Федеративні нотатки:</b>\n{}",
        "usage": "ℹ️ <b>Приклад: .{} <on/off></b>",
        "chat_only": "ℹ️ <b>Ця команда призначена для чатів</b>",
        "no_federations": "💼 <b>Немає активних федерацій</b>",
        "clrallwarns_fed": "👮‍♂️ <b>Прощено всі попередження у федерації</b>",
        "cleaning": "🧹 <b>Пошук видалених облікових записів...</b>",
        "deleted": "🧹 <b>Видалено {} видалених облікових записів</b>",
        "fcleaning": "🧹 <b>Пошук віддалених облікових записів у федерації...</b>",
        "btn_unban": "🔓 Розбанити (адмін)",
        "btn_unmute": "🔈 Розмутити (адмін)",
        "btn_unwarn": "♻️ Видалити попередження (адмін)",
        "btn_funmute": "🔈 Розмутити у федерації (адмін)",
        "btn_funban": "🔓 Розбанити у федерації (адмін)",
        "btn_mute": "🙊 Мут",
        "btn_ban": "🔒 Бан",
        "btn_fban": "💼 Фед. бан",
        "btn_del": "🗑 Видалити",
        "sync": "🔄 <b>Примусова синхронізація федерацій та чатів із сервером...</b>",
        "sync_complete": "😌 <b>Сихронізовано</b>",
        "rename_noargs": "🚫 <b>Вкажи ім'я федерації</b>",
        "suffix_removed": "📼 <b>Суфікс попередження видалено</b>",
        "suffix_updated": "📼 <b>Встановлено новий суфікс попередження</b>\n\n{}",
        "processing_myrights": "😌 <b>Обробка чатів</b>",
        "logchat_removed": "📲 <b>Логування вимкнено</b>",
        "logchat_invalid": "🚫 <b>Невірний чат логування</b>",
        "logchat_set": "📲 <b>Чат логування встановлено на </b><code>{}</code>",
        "clnraid_args": "🥷 <b>Приклад: </b><code>.clnraid 10</code>",
        "clnraid_admin": "🥷 <b>Помилка видачі прав боту. Переконайся, що у тебе достатньо прав</b>",
        "clnraid_started": "🥷 <b>RaidCleaner активний... Знайдено {} користувачів для бана...</b>",
        ...
        "clnraid_complete": "🥷 <b>RaidCleaner закінчив роботу! Вилучено: {} бот(-ів)</b>",
        "clnraid_cancelled": "🥷 <b>RaidCleaner зупинено. Видалено: {} бот(-ів)</b>",
        "confirm_rmfed_btn": "🗑 Видалити",
        "decline_rmfed_btn": "🔻 Скасування",
        "pil_unavailable": "🚫 <b>Бібліотека Pillow недоступна</b>",
        "_cmd_doc_version": "Получить информацию о модуле",
        "_cmd_doc_deleted": "Очищення віддалених облікових записів у чаті",
        "_cmd_doc_fclean": "Очищення видалених облікових записів у федерації",
        "_cmd_doc_newfed": "<shortname> <ім'я> - Створити нову федерацію",
        "_cmd_doc_rmfed": "<shortname> - Видалити федерацію",
        "_cmd_doc_fpromote": "<користувач> - Видати користувачеві права у федерації",
        "_cmd_doc_fdemote": "<shortname> <користувач> - Забрати у користувача права у федерації",
        "_cmd_doc_fadd": "<федерація> - Додати чат до федерації",
        "_cmd_doc_frm": "Видалити чат з федерації",
        "_cmd_doc_fban": "<користувач> [причина] - Забанити користувача у федерації",
        "_cmd_doc_punishsuff": "Встановити новий суфікс покарання",
        "_cmd_doc_sethclog": "Встановити чат логування",
        "_cmd_doc_funban": "<користувач> [причина] - Розбанити користувача у федерації",
        "_cmd_doc_fmute": "<пользователь> [причина] - Зробити користувача у федерації",
        "_cmd_doc_funmute": "<користувач> [причина] - Розбанити користувача у федерації",
        "_cmd_doc_kick": "<користувач> [причина] - Кікнути користувача",
        "_cmd_doc_ban": "<користувач> [причина] - Забанити користувача",
        "_cmd_doc_mute": "<користувач> [час] [причина] - Замутити користувача",
        "_cmd_doc_unmute": "<користувач> - Розмутити користувача",
        "_cmd_doc_unban": "<користувач> - Розбанити користувача",
        "_cmd_doc_protects": "Показати доступні рівні захисту",
        "_cmd_doc_feds": "Показати федерації",
        "_cmd_doc_fed": "<shortname> - Інформація про федерацію",
        "_cmd_doc_pchat": "Показати рівні захисту у чаті",
        "_cmd_doc_warn": "<користувач> - Попередити користувача",
        "_cmd_doc_warns": "[користувач] - Показати попередження в чаті \\ у користувача",
        "_cmd_doc_delwarn": "<користувач> - Пробачити останнє попередження",
        "_cmd_doc_clrwarns": "<користувач> - Пробачити всі попередження користувача",
        "_cmd_doc_clrallwarns": "Вибачити всі попередження у федерації",
        "_cmd_doc_welcome": "<text> - Змінити текст привітання",
        "_cmd_doc_fdef": "<користувач> - Включити\\вимкнути федеративний захист користувача",
        "_cmd_doc_fsave": "<note name> <reply> - Зберегти федеративну нотатку",
        "_cmd_doc_fstop": "<note name> - Видалити федеративну замітку",
        "_cmd_doc_fnotes": "Показати федеративні нотатки",
        "_cmd_doc_fdeflist": "Показати федеративний список захисту",
        "_cmd_doc_dmute": "Видалити і зробити",
        "_cmd_doc_dban": "Видалити та забанити",
        "_cmd_doc_dwarn": "Видалити та попередити",
        "_cmd_doc_fsync": "Примусова синхронізація федерацій та чатів із сервером",
        "_cmd_doc_frename": "Перейменувати федерацію",
        "_cmd_doc_myrights": "Показати всі права адміністратора у всіх чатах",
        "action": "<дія>",
        "configure": "Налаштувати",
        "toggle": "Увімкнути\\вимкнути",
        "protections": "<b>🐻 <code>.AntiArab</code> - Блокує арабів\n<b>🐺 <code>.AntiHelp</code> - Видаляє команди юзерботів, що часто використовуються\n<b>🐵 <code>.AntiTagAll</code> - Забороняє використання модуля TagAll\n<b>👋 <code>.Welcome</code> - Вітає нових учасників\n<b>🐶 <code>.AntiRaid</code> - Блокує усіх, хто знову вступив\n<b>📯 <code>.AntiChannel</code> - Забороняє писати від імені каналів\n<b>🪙 <code>.AntiSpoiler</code> - Забороняє використання спойлерів\n<b>🎑 <code>.AntiGIF</code> - Забороняє GIF-ки\n<b>⏱ <code>.AntiFlood</code> - Забороняє флудити\n<b>😒 <code>.antimat</code> - Забороняє матюкатися\n<b>⚙️ <code>.AntiService</code> - Видаляє сервісні повідомлення\n<b>🌀 <code>.AntiZALGO</code> - Баніт користувачів з деструктивними ніками\n<b>🎨 <code>.AntiStick</code> - Забороняє флудити стікерами\n<b>🥷 <code>.authorsecurity</code> - Автоматична версія захисту AntiRaid\n<b>⚰️ <code>.AntiLagSticks</code> - Банить стікери, через які глючить Телеграм\n<b>👾 Адміністрування: </b><code>.ban</code> <code>.kick</code> <code>.mute</code>\n<code>.unban</code> <code>.unmute</code>\n<b>👮‍♂️ Попередження:</b> <code>.warn</code> <code>.warns</code>\n<code>.dwarn</code> <code>.clrwarns</code> <b>- Система попереджень</b>\n<b>💼 Федерації:</b> <code>.fadd</code> <code>.frm</code> <code>.newfed</code>\n<code>.namefed</code> <code>.fban</code> <code>.rmfed</code> <code>.feds</code>\n<code>.fpromote</code> <code>.fdemote</code>\n<code>.fdef</code> <code>.fdeflist</code> <b>- Керування сіткою чатів</b>\n<b>🗒 Федеративні нотатки:</b> <code>.fsave</code> <code>.fstop</code> <code>.fnotes</code>",
        "fed": '💼 <b>Федерація "{}":</b>\n🔰 <b>Чат:</b>\n<b>{}</b>\n🔰 <b>Канал:</b>\n<b> {}</b>\n🔰 <b>Адміністратори:</b>\n<b>{}</b>\n🔰 <b>Попередження: {}</b>\n',
        "version": "<b>🪆 {}</b>\n\n<b>😌 Автор: t.me/AuthorChe | t.me/Vadym_Yem</b>\n<b>📥 Скачано из @ac_ubot</b>\n<b>{}</b>",
        "confirm_rmfed": "⚠️ <b>Увага! Цю дію не можна скасувати! Ти впевнений, що хочеш видалити федерацію </b><code>{}</code><b>?</b>",
        "_cls_doc": "Must-have модуль для адміністратора чату",
        "no_notes": "🚫 <b>Немає нотаток</b>",
    }
    ...
    async def on_unload(self):
        ...
        with contextlib.suppress(Exception):
            for _, form in self._author_security_forms.items():
                with contextlib.suppress(Exception):
                    await form.delete()
    ...
    async def versioncmd(self, message: Message):
        ...
        await utils.answer(
            ...
            self.strings("version").format(
                ...
                else ("🔁 Connecting..." if self.api._inited else "⭐️ Full"),
            ),
        )
    ...
    @error_handler
    @chat_command
    async def setaclogcmd(self, message: Message):
        """Set logchat"""
        if not utils.get_args_raw(message):
            self.set("logchat", "")
    ...
    async def p__antiservice(self, chat_id: Union[str, int], message: Message):
        if (
            ...
            and str(chat_id) not in self._author_security
    ...
    async def _update_author_security(self, chat_id: str):
        while (
            chat_id in self._author_security_forms and self._author_security[chat_id] > time.time()
        ):
            try:
                await self._author_security_forms[chat_id].edit(
                    self.strings("smart_anti_raid_active").format(
                        self._author_security_progress[chat_id]
                    ),
                    {
    ...
    async def p__authorsecurity(
        ...
        if not (
            self.api.should_protect(chat_id, "authorsecurity")
            and (
        ...
        if chat_id in self._author_security:
            if self._author_security[chat_id] > time.time():
                self._author_security[chat_id] = time.time() + int(
                    self.config["authorsecurity_cooldown"]
                )
                await self.inline.bot.kick_chat_member(int(f"-100{chat_id}"), user_id)

                self._author_security_progress[chat_id] += 1
        ...
        if len(self._join_ratelimit[chat_id]) >= int(self.config["join_ratelimit"]):
            ...
            self._author_security[chat_id] = round(time.time()) + int(
                self.config["authorsecurity_cooldown"]
            )
            ...
            try:
                chat = await message.get_chat()
                self._author_security_default_rights[chat_id] = chat.default_banned_rights
                await self._client(
            ...
            self._author_security_forms[chat_id] = form
            self._author_security_progress[chat_id] = int(self.config["join_ratelimit"])
            self._author_security_tasks[chat_id] = asyncio.ensure_future(
                self._update_author_security(chat_id)
            )
            ...
            for m in self._author_security_messages:
                try:
                    await self.inline.bot.delete_message(
    ...
    async def disable_smart_anti_raid(self, call: InlineCall, chat_id: int):
        chat_id = str(chat_id)
        if chat_id in self._author_security:
            del self._author_security[chat_id]
            if call:
            ...
            try:
                await self._client.unpin_message(
                    int(chat_id),
                    self._author_security_forms[str(chat_id)].form["message_id"],
                )
            except Exception:
                pass
            ...
            try:
                await self._client(
                    EditChatDefaultBannedRightsRequest(
                        int(chat_id),
                        self._author_security_default_rights[chat_id],
                    )
                )
                del self._author_security_default_rights[chat_id]
            except Exception:
                pass

            await self._client.send_message(
                int(chat_id),
                self.strings("authorsecurity_report").format(
                    self._author_security_progress[chat_id]
                ),
            )

            if chat_id in self._author_security_forms:
                await self._author_security_forms[chat_id].delete()
                del self._author_security_forms[chat_id]

            if chat_id in self._author_security_progress:
                del self._author_security_progress[chat_id]

            if chat_id in self._author_security_tasks:
                self._author_security_tasks[chat_id].cancel()
                del self._author_security_tasks[chat_id]
    ...
    async def p__welcome(
        ...
        if (
            ...
            self._author_security_messages = [m] + self._author_security_messages
            self._author_security_messages = self._author_security_messages[
    ...
    async def _global_queue_handler_process(self, message: Message):
        ...
        if await self.p__authorsecurity(chat_id, user_id, message):
            return
    ...
    _author_security = {}
    _author_security_messages = []
    _author_security_forms = {}
    _author_security_progress = {}
    _author_security_tasks = {}
    _author_security_default_rights = {}
    ...
    async def client_ready(
        self,
        client: "TelegramClient",  # type: ignore
        db: "acbot.database.Database",  # type: ignore
    ):
        """Entry point"""
        global api
        ...
        self.__doc__ = (
            "Advanced chat admin toolkit\n\n💻 Developer: t.me/AuthorChe | t.me/Vadym_Yem\n📣 Downloaded from: @ac_ubot\n\n"
            + f"📦Version: {version}\n"
            + ("⭐️ Full" if not self.api._inited else "⭐️ Full")
        )
