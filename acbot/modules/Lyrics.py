...
class LyricsMod(loader.Module):
    ...
    strings_ru = {
        "_cls_doc": "Пошук текстів пiсень з Genius",
        "_cmd_doc_lyrics": "Отримати слова пісні",
        "_cmd_doc_slyrics": "Spotify, "
                            "для работоспособности требуется модуль SpotifyNow",
        "_ihandle_doc_lyrics": "Пошук текстів песень",
        "type_name": "<b>🚫 Будь ласка, введіть назву композиції</b>",
        "genius": "🎵 Весь текст в браузері",
        "noSpotify": "<b>🚫 Пожалуйста установи модуль SpotifyNow и пройди авторизацию.</b>\n"
                     "🌃 Установка: <code>.dl spotify</code>",
        "notFound": "🚫 Не маю тексту",
        "couldn'tFind": "На жаль я не знайшов нічого, по вашому запиту",
        "sauth": "<b>🚫 Выполни <code>.sauth</code> перед этим действием.</b>",
        "SpotifyError": "<b>🚫 Ошибка Спотифай</b>",
        "noResults": "<b>🚫 Результати для <code>{}</code> не знайдено</b>",
        "noLyrics": "<b>🚫 На жаль я не знайшов нічого, по вашому запиту</b>",
        "lyrics": "Текст пісні <b>{}</b> від <b>{}</b>\n<i>{}",
        "loading": "Завантаження тексту пісні <b>{}</b> від <b>{}</b>...\n{}"
    }
    ...
    async def watcher(self, message: Message) -> None:
        if (
                ...
                or "Завантаження тексту пісні" in getattr(message, "raw_text", "")
        )
        ):
            e = message.entities
            track = {
